"""Comprehensive guide to ComfyUI custom nodes.

Knowledge about popular custom nodes, their installation,
node names, and how to use them in workflows.
"""


class CustomNodesGuide:
    """Guide to ComfyUI custom nodes and extensions."""

    @staticmethod
    def get_full_custom_nodes_knowledge() -> str:
        """Get complete custom nodes knowledge for system prompts."""
        return f"""
{CustomNodesGuide.get_node_detection()}

{CustomNodesGuide.get_essential_packs()}

{CustomNodesGuide.get_video_nodes()}

{CustomNodesGuide.get_controlnet_nodes()}

{CustomNodesGuide.get_upscale_nodes()}

{CustomNodesGuide.get_face_nodes()}

{CustomNodesGuide.get_utility_nodes()}

{CustomNodesGuide.get_wan_svi_nodes()}

{CustomNodesGuide.get_installation_guide()}

{CustomNodesGuide.get_dependency_chains()}
"""

    @staticmethod
    def get_node_detection() -> str:
        return """
