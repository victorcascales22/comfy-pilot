"""Advanced video generation knowledge.

Comprehensive knowledge about WAN 2.2, SVI Pro, and advanced video tricks.
"""


class VideoAdvanced:
    """Advanced video generation techniques and models."""

    @staticmethod
    def get_full_video_knowledge() -> str:
        """Get complete advanced video knowledge for system prompts."""
        return f"""
{VideoAdvanced.get_wan_22_knowledge()}

{VideoAdvanced.get_svi_pro_knowledge()}

{VideoAdvanced.get_hunyuan_video_knowledge()}

{VideoAdvanced.get_advanced_video_tricks()}

{VideoAdvanced.get_video_workflows()}

{VideoAdvanced.get_video_quality_fixes()}

{VideoAdvanced.get_frame_interpolation()}

{VideoAdvanced.get_video_to_video()}
"""

    @staticmethod
    def get_wan_22_knowledge() -> str:
        return """
## WAN 2.2 (ComfyUI-WAN)
...
"""
    ...
    @staticmethod
    def get_hunyuan_video_knowledge() -> str:
        return """
...
"""
    ...
    @staticmethod
    def get_advanced_video_tricks() -> str:
        return """
...
"""
    ...
    @staticmethod
    def get_video_quality_fixes() -> str:
        return """
...
"""
    ...
    @staticmethod
    def get_frame_interpolation() -> str:
        return """
