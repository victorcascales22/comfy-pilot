"""Comprehensive ComfyUI knowledge base for agents.

This module contains detailed information about ComfyUI nodes, workflows,
models, and best practices that agents use to generate accurate workflows.
"""


class ComfyUIKnowledge:
    """Knowledge base about ComfyUI for AI agents."""

    @staticmethod
    def get_full_knowledge() -> str:
        """Get complete ComfyUI knowledge for system prompts."""
        return f"""
{ComfyUIKnowledge.get_core_nodes()}

{ComfyUIKnowledge.get_model_types()}

{ComfyUIKnowledge.get_workflow_patterns()}

{ComfyUIKnowledge.get_tiling_knowledge()}

{ComfyUIKnowledge.get_video_knowledge()}

{ComfyUIKnowledge.get_advanced_techniques()}

{ComfyUIKnowledge.get_custom_nodes_knowledge()}

{ComfyUIKnowledge.get_optimization_tips()}
"""

    @staticmethod
    def get_core_nodes() -> str:
        return """
## CORE COMFYUI NODES
...
"""
    ...
    @staticmethod
    def get_advanced_techniques() -> str:
        return """
## ADVANCED TECHNIQUES
...
"""
    ...
    @staticmethod
    def get_custom_nodes_knowledge() -> str:
        return """
