"""Knowledge base for workflow tuning and troubleshooting.

Common issues, parameter adjustments, and optimization tricks.
"""


class WorkflowTuning:
    """Knowledge about tuning workflows based on user feedback."""

    @staticmethod
    def get_full_tuning_knowledge() -> str:
        """Get complete tuning knowledge for system prompts."""
        return f"""
{WorkflowTuning.get_common_issues()}

{WorkflowTuning.get_parameter_effects()}

{WorkflowTuning.get_img2img_tuning()}

{WorkflowTuning.get_video_tuning()}

{WorkflowTuning.get_quality_improvements()}

{WorkflowTuning.get_style_adjustments()}

{WorkflowTuning.get_controlnet_tuning()}

{WorkflowTuning.get_upscale_tuning()}
"""
...
"""
    ...
    @staticmethod
    def get_quality_improvements() -> str:
        return """
