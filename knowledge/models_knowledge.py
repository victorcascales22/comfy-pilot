"""Knowledge base about popular models, checkpoints, and LoRAs.

Includes current top models, classics, NSFW options, and recommendations.
"""


class ModelsKnowledge:
    """Comprehensive knowledge about Stable Diffusion models and related resources."""

    @staticmethod
    def get_full_models_knowledge() -> str:
        """Get complete models knowledge for system prompts."""
        return f"""
{ModelsKnowledge.get_top_models_2025()}

{ModelsKnowledge.get_classic_models()}

{ModelsKnowledge.get_nsfw_models()}

{ModelsKnowledge.get_flux_models()}

{ModelsKnowledge.get_video_models()}

{ModelsKnowledge.get_popular_loras()}

{ModelsKnowledge.get_model_sources()}

{ModelsKnowledge.get_vae_knowledge()}

{ModelsKnowledge.get_recommendations()}
"""

    @staticmethod
    def get_top_models_2025() -> str:
        return """
## TOP MODELS 2025
